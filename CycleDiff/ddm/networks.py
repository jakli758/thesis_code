...
class MsImageDis(nn.Module):
    ...
    def __init__(self, input_dim=3, dim=64, norm='none', activ='lrelu', n_layer=4, gan_type='lsgan', num_scales=3, pad_type='reflect'):
...
class AdaINGen(nn.Module):
    ...
    def __init__(self, input_dim=3, dim=64, mlp_dim=256, style_dim=8, output_dim=4, activ='relu', n_downsample=2, n_res=4, pad_type='pad_type'):
